...
const AccountScreen = ({navigation}) => {
  ...
  const navigateToProfile = () => {
    navigation.navigate('UserProfile'); // Điều hướng đến trang UserProfile
  };
  const navigateToMaps = () => {
    navigation.navigate('GoogleMap'); // Điều hướng đến trang Google Maps
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        <View>
          <Feather name="bell" size={20} color={Color.DEFAULT_WHITE} />
      ...
      <View style={styles.menuContainer}>
        ...
        <TouchableOpacity style={styles.menuItem} activeOpacity={0.8}>
          <View style={{...styles.menuIcon, backgroundColor: Color.LIGHT_RED}}>
            <MaterialCommunityIcons
              name="gift-outline"
              size={18}
        ...
        <TouchableOpacity style={styles.menuItem} activeOpacity={0.8} onPress={navigateToMaps}>
          <View
            style={{...styles.menuIcon, backgroundColor: Color.LIGHT_YELLOW}}>
            <Ionicons
      ...
      <View style={styles.mainContainer}>
        ...
        <TouchableOpacity style={styles.sectionContainer} activeOpacity={0.8} onPress={navigateToProfile}>
        ...
        <View style={styles.sectionContainer} activeOpacity={0.8}>
          <View style={styles.sectionTextContainer}>
            <Feather name="bell" size={18} color={Color.DEFAULT_GREEN} />
